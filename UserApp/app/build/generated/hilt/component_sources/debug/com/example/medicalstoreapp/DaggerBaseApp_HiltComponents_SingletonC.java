...
import com.example.medicalstoreapp.di.HiltModule_ProvideApiFactory;
import com.example.medicalstoreapp.di.HiltModule_ProvidePrefsFactory;
import com.example.medicalstoreapp.di.HiltModule_ProvideRepoFactory;
...
import com.example.medicalstoreapp.viewModel.MyViewModel_HiltModules;
...
public final class DaggerBaseApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_medicalstoreapp_viewModel_MyViewModel, MyViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_medicalstoreapp_viewModel_MyViewModel = "com.example.medicalstoreapp.viewModel.MyViewModel";

      @KeepFieldType
      MyViewModel com_example_medicalstoreapp_viewModel_MyViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends BaseApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_medicalstoreapp_viewModel_MyViewModel, ((Provider) myViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.medicalstoreapp.viewModel.MyViewModel 
          return (T) new MyViewModel(singletonCImpl.provideRepoProvider.get(), singletonCImpl.providePrefsProvider.get());
  ...
  private static final class SingletonCImpl extends BaseApp_HiltComponents.SingletonC {
    ...
    private Provider<Api_Builder> provideApiProvider;

    private Provider<Repo> provideRepoProvider;

    private Provider<MyPreference> providePrefsProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideApiProvider = DoubleCheck.provider(new SwitchingProvider<Api_Builder>(singletonCImpl, 1));
      this.provideRepoProvider = DoubleCheck.provider(new SwitchingProvider<Repo>(singletonCImpl, 0));
      this.providePrefsProvider = DoubleCheck.provider(new SwitchingProvider<MyPreference>(singletonCImpl, 2));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.medicalstoreapp.repo.Repo 
          return (T) HiltModule_ProvideRepoFactory.provideRepo(singletonCImpl.provideApiProvider.get());

          case 1: // com.example.medicalstoreapp.api.Api_Builder 
          return (T) HiltModule_ProvideApiFactory.provideApi();

          case 2: // com.example.medicalstoreapp.prefData.MyPreference 
          return (T) HiltModule_ProvidePrefsFactory.providePrefs(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
