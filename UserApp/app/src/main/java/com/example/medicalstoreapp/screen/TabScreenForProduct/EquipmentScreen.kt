        ...
        state.value.isdata != null -> {
            ...
            Column(
                ...
                Row(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .padding(start = 15.dp)
                            .clickable {
                                navHostController.navigate(Routes.HomeScreenRoutes(user_id = userId))
                            }
                    )
                    Spacer(Modifier.width(60.dp))

                    Text(text = "Equipments", fontSize = 40.sp, fontWeight = FontWeight.Bold)
                ...
                LazyColumn(
                    ...
                    val getEquipment = state.value.isdata
...
fun AllEquipment(
    ...
    if (res.category.toString() == "Equipment") {
        ...
        Card(
            modifier = Modifier
                ...
                .padding(15.dp)
                .clickable {
                    Log.d("TAG", "AllEquipment in addorder:${userId}")
            ...
            Log.d("TAG", "AllEquipment : ${userId.toString()}")
            Box(
