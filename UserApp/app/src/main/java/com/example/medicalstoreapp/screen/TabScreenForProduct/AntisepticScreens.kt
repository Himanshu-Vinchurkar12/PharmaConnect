        ...
        state.value.isdata != null -> {
            ...
            Column(
                ...
                Row(
                    ...
                    Text(text = "Antiseptic", fontSize = 40.sp, fontWeight = FontWeight.Bold)
    ...
    if (res.category.toString() == "Antiseptic") {
        ...
        Card(
            modifier = Modifier
                ...
                .padding(15.dp)
                .clickable {
                    Log.d("TAG", "AllEquipment in addorder in Antiseptic :${userId}")
            ...
            Log.d("TAG", "AllEquipment in Antiseptic : ${userId.toString()}")
